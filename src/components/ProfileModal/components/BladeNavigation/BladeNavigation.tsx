...
import BladeTab from '../BladeTab';
import PageLayout from '../PageLayout';
import type { BladeNavigationProps } from '../../types';
import styles from './BladeNavigation.module.css';
import modalStyles from '../../ProfileModal.module.css';

const BladeNavigation = memo<BladeNavigationProps>(({
  pages,
  initialPageId,
  onPageChange,
}) => {
...
BladeNavigation.displayName = 'BladeNavigation';
